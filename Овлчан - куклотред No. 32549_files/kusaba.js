            ...
            if (d.getAttribute('id').substr(0, 3) == 'dnb') {
                ...
                new Ajax.Request(ku_boardspath + "/manage_page.php?action=getip&boarddir=" + e[1] + "&id=" + e[2], {
                    ...
                    onSuccess: function(a) {
                        ...
                        span.innerHTML = "[IP: " + ipaddr[1] + " • Useragent: " + ipaddr[2] + " • Hash: " + ipaddr[3] + "] [<a href=\"" + ku_boardspath + "/manage_page.php?action=deletepostsbyip&ip=" + ipaddr[1] + "\" title=\"" + _('Delete all posts by this IP') + "\">D</a> / <a href=\"" + ku_boardspath + "/manage_page.php?action=ipsearch&ip=" + ipaddr[1] + "\" title=\"" + _('Search for posts with this IP') + "\">S</a>] " + span.innerHTML
                    },
                    onFailure: function() {
                ...
                f += 'id=' + e[2] + '" title="' + _('Delete') + '" onclick="return confirm(_(\'Are you sure you want to delete this post/thread?\'));">D<\/a>&nbsp;<a href="' + ku_cgipath + '/manage_page.php?action=delposts&boarddir=' + e[1] + '&del';
                if (e[3] == 'y') {
                    f += 'thread'
                } else {
                    f += 'post'
                }
                f += 'id=' + e[2] + '&postid=' + e[2] + '" title="' + _('Delete &amp; Ban') + '" onclick="return confirm(_(\'Are you sure you want to delete and ban the poster of this post/thread?\'));">&amp;<\/a>&nbsp;<a href="' + ku_cgipath + '/manage_page.php?action=bans&banboard=' + e[1] + '&banpost=' + e[2] + '" title="' + _('Ban') + '">B<\/a>&#93;&nbsp;&#91;<a href="' + ku_cgipath + '/manage_page.php?action=bans&banboard=' + e[1] + '&banpost=' + e[2] + '&instant=y" title="' + _('Instant Permanent Ban') + '" onclick="instantban(\'' + e[1] + '\',' + e[2] + '); return false;">P<\/a>&#93;&nbsp;&#91;<a href="' + ku_cgipath + '/manage_page.php?action=delposts&boarddir=' + e[1] + '&del';
                if (e[3] == 'y') {
                    f += 'thread'
                } else {
                    f += 'post'
                }
                f += 'id=' + e[2] + '&postid=' + e[2] + '&cp=y" title="' + _('Child Pornography') + '" onclick="return confirm(_(\'Are you sure that this is child pornography?\'));">CP<\/a>&#93;';
                c[i].innerHTML = f
            }
        }
    }
